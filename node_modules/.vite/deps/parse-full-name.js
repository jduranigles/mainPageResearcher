...
var require_parse_full_name = __commonJS({
  "node_modules/parse-full-name/index.js"(exports) {
    exports.parseFullName = function parseFullName(nameToParse, partToReturn, fixCase, stopOnError, useLongLists) {
      "use strict";
      ...
      partToReturn = partToReturn && [
        ...
        "suffix",
        "error"
      ].indexOf(partToReturn.toLowerCase()) > -1 ? partToReturn.toLowerCase() : "all";
      if (fixCase === false)
        fixCase = 0;
      if (fixCase === true)
        fixCase = 1;
      fixCase = fixCase !== "undefined" && (fixCase === 0 || fixCase === 1) ? fixCase : -1;
      if (stopOnError === true)
        stopOnError = 1;
          ...
          for (i = 0, l = namePartLabels.length; i < l; i++) {
            if (fixedCaseName[namePartLabels[i]]) {
              ...
              for (j = 0, m = namePartWords.length; j < m; j++) {
                forceCaseListIndex = forceCaseList.map(function(v) {
                ...
                } else if (namePartWords[j].length > 2 && namePartWords[j].slice(0, 1) === namePartWords[j].slice(0, 1).toUpperCase() && namePartWords[j].slice(1, 2) === namePartWords[j].slice(1, 2).toLowerCase() && namePartWords[j].slice(2) === namePartWords[j].slice(2).toUpperCase()) {
...
export default require_parse_full_name();
//# sourceMappingURL=parse-full-name.js.map
